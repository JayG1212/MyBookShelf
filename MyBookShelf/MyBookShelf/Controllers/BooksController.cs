...
namespace MyBookShelf.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,Pages,PublicationYear,AuthorID,GenreID,ShelfID")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,Pages,PublicationYear,AuthorID,GenreID,ShelfID")] Book book)
        {
            if (id != book.ID)
            {
                return NotFound();
